...
class Form13KAggregator extends Transformer[Dataset[String], Dataset[(String, Long)]] {
...
class Form13KProcessor extends Transformer[Dataset[String], Dataset[(String, Long)]] { 
